    ...
    <section id="#" className="flex flex-col">
      <div className="md:flex">
        <div className="md:w-1/2 mt-3 md:mt-0 flex flex-col justify-center gap-5">
          ...
          <p className="text-gray-500">
            Hi, I'm Angko Musyafa Jalil. A passionate Front-End React Developer
      ...
      <div className="flex gap-10 mt-10 md:mt-20 justify-center md:justify-start items-center">
        ...
        <div className="flex flex-wrap gap-5 md:gap-10 flex-1 justify-center md:justify-start">
          <FaHtml5 size={24} className="fill-orange-500" title="HTML" />
          <FaCss3Alt size={24} className="fill-blue-500" title="CSS" />
          <SiJavascript
            size={24}
          ...
          <SiTailwindcss
            ...
            title="Tailwind CSS"
          />
          <FaReact size={24} className="fill-sky-500" title="React JS" />
        </div>
      </div>
    </section>
  );
